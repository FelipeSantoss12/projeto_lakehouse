...
fake = Faker('pt_BR')  # Configurando Faker para gerar dados em português brasileiro
...
caminho_raw_cadastros = './data/raw_data/cadastros/'
caminho_raw_pedidos = './data/raw_data/pedidos/'
